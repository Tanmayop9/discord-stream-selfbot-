...
import { Streamer, Utils, prepareStream, playStream } from "discord-stream-selfbot-yt";
...
streamer.client.on("messageCreate", async (msg) => {
    ...
    if (msg.content.startsWith("$play-live")) {
        ...
        // prepareStream now supports YouTube URLs!
        const { command, output } = await prepareStream(args.url, {
